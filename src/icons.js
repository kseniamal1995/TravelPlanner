/* Единая inline-SVG библиотека в стиле Lucide (см. docs/04-design-system.md). */
export const PATHS = {
  ext: '<path d="M7 17 17 7"/><path d="M8 7h9v9"/>',
  chup: '<polyline points="6 14 12 8 18 14"/>',
  chdn: '<polyline points="6 10 12 16 18 10"/>',
...
export const CHDN = ic('chdn', 17);
export const PEN = ic('pen', 14);
export const TRASH = ic('trash', 16);

// Карта вида транспорта → иконка.
